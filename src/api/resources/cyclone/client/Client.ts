...
export declare namespace Cyclone {
...
export class Cyclone {
    constructor(protected readonly _options: Cyclone.Options) {}

    /**
     * Query the available cyclone forecasts for a particular time
     *
     * @param {Earth.QueryForecastsCycloneForecastsGetRequest} request
     * @param {Cyclone.RequestOptions} requestOptions - Request-specific configuration.
     *
