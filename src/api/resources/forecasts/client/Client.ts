...
export class Forecasts {
    ...
    public async createDaily(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.SilurianEnvironment.Production,
                "forecast/daily"
            ),
            method: "GET",
            headers: {
                ...
                "X-Fern-SDK-Version": "0.0.1-alpha4",
                "User-Agent": "silurian-ai/0.0.1-alpha4",
