...
export class ForecastClient {
    ...
    private async __daily(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/past/forecast/daily");
    }
    ...
    private async __hourly(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/past/forecast/hourly");
    }
}
