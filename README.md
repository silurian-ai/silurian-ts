...
A full reference for this library is available [here](https://github.com/silurian-ai/silurian-ts/blob/HEAD/./reference.md).
...
```typescript
import { EarthClient, EarthEnvironment } from "silurian";
...
```typescript
import { PortfoliosClient } from 'silurian/portfolios';

const client = new PortfoliosClient({...});
```
...
```typescript
import { EarthClient, logging } from "silurian";
